...
<div class="table-responsive">
	<table class="shop_table table table-bordered">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'camel-framework' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'camel-framework' ); ?></th>
			</tr>
		</thead>
		<tbody>
	...
	<div id="payment" class="bg-light p-4 mb-2">
